...
public class HeapPage implements Page {
    ...
    */
    private int getNumTuples() {        
        // floor((BufferPool.PAGE_SIZE * 8) / (_tuple size_ * 8 + 1))
    ...
    public void deleteTuple(Tuple t) throws DbException {
        ...
        if (!t.getRecordId().getPageId().equals(getId())) {
            throw new DbException("tuple absent");
        }

        if (!isSlotUsed(tNo)) {
            throw new DbException("slot already free");
        }

        markSlotUsed(tNo, false);
        this.tuples[tNo] = null;
    }
    ...
    public void insertTuple(Tuple t) throws DbException {
        ...
        // traverse the slots until finding a free slot
